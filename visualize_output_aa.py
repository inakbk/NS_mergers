...
def evolve_time_saveplot(Time,A_array,solar_mass_frac,mass_frac_evo,mass_frac_fin):
    ...
    for i in range(2):
        ...
        plt.tight_layout()
        plt.savefig('Abon/animation_figures/time_evo{}_{:06d}.png'.format(ID_trajectory,i+1)) 
        plt.close()
...
# Make the movie:
#create_animation_from_plots(play='yes', plotname='time_evo{}_'.format(ID_trajectory),name='ab_anim_{}'.format(ID_trajectory))
